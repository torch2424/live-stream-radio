...
## What are some reccomended bit rates

Here is the [Youtube Reccomended Livestream](https://support.google.com/youtube/answer/2853702?hl=en) configuration for streaming software.
